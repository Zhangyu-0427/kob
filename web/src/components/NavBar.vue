<template>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <!-- 导航栏设置为黑色背景 <nav class="navbar navbar-expand-lg navbar-dark bg-dark"> -->
    <div class="container">
      <router-link :class="route_name == 'home' ? 'navbar-brand active' : 'navbar-brand'" :to="{ name: 'home' }"
